...
const zhCN = {
  ...
  theme: "主题", themeSystem: "跟随系统", themeDark: "深色", themeLight: "浅色", earlierSteps: "… 前面还有 {count} 步", runtimeEvents: "运行时事件", runtimeEventsPending: "还等着你处理", ignoreEvent: "忽略", eventSeenByAgent: "Agent 已看过，仍需你处理", eventNotDelivered: "尚未交给 Agent",
...
const en: Messages = {
  ...
  theme: "Theme", themeSystem: "System", themeDark: "Dark", themeLight: "Light", earlierSteps: "… {count} earlier step(s)", runtimeEvents: "Runtime events", runtimeEventsPending: "Still waiting on you", ignoreEvent: "Ignore", eventSeenByAgent: "Seen by the agent, still yours to handle", eventNotDelivered: "Not delivered to the agent yet",
...
const ja: Messages = {
  ...
  theme: "テーマ", themeSystem: "システムに従う", themeDark: "ダーク", themeLight: "ライト", earlierSteps: "… 前に {count} ステップ", runtimeEvents: "ランタイムイベント", runtimeEventsPending: "あなたの対応待ち", ignoreEvent: "無視", eventSeenByAgent: "Agent は確認済み、対応は必要", eventNotDelivered: "Agent へ未配信",
