...
const zhCN = {
  ...
  theme: "主题", themeSystem: "跟随系统", themeDark: "深色", themeLight: "浅色", earlierSteps: "… 前面还有 {count} 步", foldedSteps: "{count} 步", foldedFailed: " · {count} 失败", runtimeEvents: "运行时事件", runtimeEventsPending: "还等着你处理", ignoreEvent: "忽略", eventSeenByAgent: "Agent 已看过，仍需你处理", eventNotDelivered: "尚未交给 Agent",
  ...
  allowOnce: "允许一次", deny: "拒绝", alwaysAllow: "始终允许", submitAnswer: "提交", otherAnswer: "其他回答", instruct: "补充指令", retry: "重试", retryWaiting: "等待重试", changeModel: "换模型重试", agentPrompt: "输入要补充给 Agent 的指令", agentModelPrompt: "输入重试要使用的模型", runtimeActionFailed: "Runtime 操作失败",
  ...
  hintIdle: "轮到你 · Enter 发送 · Shift+Enter 换行", hintBusy: "本轮进行中 · 回车即送达 · 右侧按钮停止",
  turnFinished: "本轮结束", totalElapsed: "总耗时", toolCount: "工具 {count} 次", yourTurn: "轮到你",
  ...
  rewindSession: "回到第 N 步", rewindDialogTitle: "回到第 N 步", rewindLoading: "正在读取步骤…", rewindNoPoints: "没有可回退的步骤", rewindBeginning: "开头", rewindStep: "第 {step} 步", rewindFilesAvailable: "有文件检查点", rewindChatOnly: "仅对话", rewindRestoreFiles: "同时把工作区文件恢复到这一步", rewindRestoreUnavailable: "这一步没有文件检查点，只能回对话", rewindDropHint: "之后的 {count} 步会被丢弃；被覆盖的文件原件进回收区，回退前的工作树另有快照。", rewindConfirm: "回退", rewindDone: "已回到第 {step} 步，丢弃 {dropped} 步", rewindDoneBeginning: "已回到开头，丢弃 {dropped} 步", rewindFilesSummary: "文件恢复 {restored} 个、移除 {removed} 个",
  ...
  pluginPermConversationWrite: "把文本递给主 Agent", pluginPermAiImage: "生成图片", pluginPermSkillsRead: "读技能清单",
  pluginUnsupported: "本宿主不支持", pluginRunCommandConfirm: "这个插件页面要在你的工作区里执行一条命令：",
  ...
  accessReadOnly: "只读", accessStrict: "严格", accessSmart: "智能", accessWrite: "可写", accessFull: "完全访问",
  settings: "设置",
...
const en: Messages = {
  ...
  theme: "Theme", themeSystem: "System", themeDark: "Dark", themeLight: "Light", earlierSteps: "… {count} earlier step(s)", foldedSteps: "{count} step(s)", foldedFailed: " · {count} failed", runtimeEvents: "Runtime events", runtimeEventsPending: "Still waiting on you", ignoreEvent: "Ignore", eventSeenByAgent: "Seen by the agent, still yours to handle", eventNotDelivered: "Not delivered to the agent yet",
  ...
  allowOnce: "Allow once", deny: "Deny", alwaysAllow: "Always allow", submitAnswer: "Submit", otherAnswer: "Other answer", instruct: "Instruct", retry: "Retry", retryWaiting: "Waiting to retry", changeModel: "Retry with model", agentPrompt: "Enter an instruction for the Agent", agentModelPrompt: "Enter the model to use for the retry", runtimeActionFailed: "Runtime action failed",
  ...
  promptPlaceholder: "Describe the task you want to complete…", inputSuggestionAccept: "Tab to accept", send: "Send", working: "Working",
  steerPlaceholder: "Turn running · Enter delivers now without interrupting", steered: "Delivered · the model sees it at its next step",
  steerUnavailable: "This turn is not attached to the Runtime yet, or has attachments; send after it finishes",
  ...
  hintIdle: "Your turn · Enter to send · Shift+Enter for newline", hintBusy: "Turn running · Enter delivers now · stop with the button",
  turnFinished: "turn finished", totalElapsed: "total", toolCount: "tools {count}", yourTurn: "your turn",
  ...
  rewindSession: "Rewind to a step", rewindDialogTitle: "Rewind to a step", rewindLoading: "Loading steps…", rewindNoPoints: "Nothing to rewind to", rewindBeginning: "Beginning", rewindStep: "Step {step}", rewindFilesAvailable: "file checkpoint", rewindChatOnly: "chat only", rewindRestoreFiles: "Also restore workspace files to this step", rewindRestoreUnavailable: "This step has no file checkpoint; only the conversation can be rewound", rewindDropHint: "The {count} later step(s) will be dropped; overwritten files go to the recovery area and the pre-rewind tree is snapshotted.", rewindConfirm: "Rewind", rewindDone: "Rewound to step {step}, dropped {dropped} step(s)", rewindDoneBeginning: "Rewound to the beginning, dropped {dropped} step(s)", rewindFilesSummary: "{restored} file(s) restored, {removed} removed",
  ...
  pluginPermConversationWrite: "Hand text to the main agent", pluginPermAiImage: "Generate images", pluginPermSkillsRead: "Read the skill list",
  pluginUnsupported: "Not supported by this host", pluginRunCommandConfirm: "This plugin page wants to run a command in your workspace:",
  ...
  accessReadOnly: "read", accessStrict: "strict", accessSmart: "smart", accessWrite: "write", accessFull: "full access",
  settings: "Settings",
...
const ja: Messages = {
  ...
  theme: "テーマ", themeSystem: "システムに従う", themeDark: "ダーク", themeLight: "ライト", earlierSteps: "… 前に {count} ステップ", foldedSteps: "{count} ステップ", foldedFailed: " · {count} 失敗", runtimeEvents: "ランタイムイベント", runtimeEventsPending: "あなたの対応待ち", ignoreEvent: "無視", eventSeenByAgent: "Agent は確認済み、対応は必要", eventNotDelivered: "Agent へ未配信",
  ...
  allowOnce: "一度許可", deny: "拒否", alwaysAllow: "常に許可", submitAnswer: "送信", otherAnswer: "その他の回答", instruct: "指示を追加", retry: "再試行", retryWaiting: "再試行を待機中", changeModel: "モデルを変更して再試行", agentPrompt: "Agent への追加指示を入力", agentModelPrompt: "再試行に使用するモデルを入力", runtimeActionFailed: "Runtime 操作に失敗しました",
  ...
  hintIdle: "あなたの番 · Enter で送信 · Shift+Enter で改行", hintBusy: "ターン実行中 · Enter で即時送達 · 停止はボタンで",
  turnFinished: "ターン終了", totalElapsed: "合計", toolCount: "ツール {count} 回", yourTurn: "あなたの番",
  ...
  rewindSession: "ステップに戻す", rewindDialogTitle: "ステップに戻す", rewindLoading: "ステップを読み込み中…", rewindNoPoints: "戻せるステップがありません", rewindBeginning: "最初", rewindStep: "ステップ {step}", rewindFilesAvailable: "ファイルのチェックポイントあり", rewindChatOnly: "会話のみ", rewindRestoreFiles: "ワークスペースのファイルもこのステップに戻す", rewindRestoreUnavailable: "このステップにファイルのチェックポイントはなく、会話のみ戻せます", rewindDropHint: "以降の {count} ステップは破棄されます。上書きされたファイルは回収領域へ、巻き戻し前のツリーはスナップショットに残ります。", rewindConfirm: "戻す", rewindDone: "ステップ {step} に戻しました（{dropped} ステップを破棄）", rewindDoneBeginning: "最初に戻しました（{dropped} ステップを破棄）", rewindFilesSummary: "ファイル {restored} 件を復元、{removed} 件を削除",
  ...
  pluginPermConversationWrite: "メインエージェントへのテキスト受け渡し", pluginPermAiImage: "画像の生成", pluginPermSkillsRead: "スキル一覧の読み取り",
  pluginUnsupported: "このホストでは未対応", pluginRunCommandConfirm: "このプラグインページがワークスペースでコマンドを実行しようとしています:",
  ...
  accessReadOnly: "読取", accessStrict: "厳格", accessSmart: "スマート", accessWrite: "書込", accessFull: "フルアクセス",
  settings: "設定",
