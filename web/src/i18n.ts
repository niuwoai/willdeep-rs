...
const zhCN = {
  ...
  runtimeActivity: "Runtime 活动", tools: "工具", running: "运行中", artifacts: "产物", agents: "Agent", agent: "Agent", needsAttention: "需要处理", waitingApproval: "等待审批", waitingAnswer: "等待回答", blocked: "已阻塞", turn: "轮次",
...
const en: Messages = {
  ...
  runtimeActivity: "Runtime activity", tools: "Tools", running: "Running", artifacts: "Artifacts", agents: "Agents", agent: "Agent", needsAttention: "Needs attention", waitingApproval: "Waiting for approval", waitingAnswer: "Waiting for answer", blocked: "Blocked", turn: "Turn",
...
const ja: Messages = {
  ...
  runtimeActivity: "Runtime アクティビティ", tools: "ツール", running: "実行中", artifacts: "成果物", agents: "Agent", agent: "Agent", needsAttention: "要対応", waitingApproval: "承認待ち", waitingAnswer: "回答待ち", blocked: "ブロック中", turn: "ターン",
