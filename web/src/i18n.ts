...
const zhCN = {
  ...
  newReadOnlyAgent: "新建只读子 Agent", agentProfile: "Agent 类型", agentProfileScout: "侦查", agentProfileReader: "阅读", agentProfileLogInspector: "日志分析", agentProfileGitDetective: "Git 追溯", agentTask: "Agent 任务", agentTaskPlaceholder: "描述独立调查任务", spawnAgent: "创建", activeSessionRequired: "请先发送一个任务；父会话运行期间可创建子 Agent。",
...
const en: Messages = {
  ...
  newReadOnlyAgent: "New read-only child Agent", agentProfile: "Agent profile", agentProfileScout: "Scout", agentProfileReader: "Reader", agentProfileLogInspector: "Log inspector", agentProfileGitDetective: "Git detective", agentTask: "Agent task", agentTaskPlaceholder: "Describe an independent investigation", spawnAgent: "Create", activeSessionRequired: "Send a task first; child Agents can be created while the parent session is active.",
...
const ja: Messages = {
  ...
  newReadOnlyAgent: "読み取り専用子 Agent を作成", agentProfile: "Agent プロファイル", agentProfileScout: "偵察", agentProfileReader: "読解", agentProfileLogInspector: "ログ解析", agentProfileGitDetective: "Git 追跡", agentTask: "Agent タスク", agentTaskPlaceholder: "独立した調査タスクを入力", spawnAgent: "作成", activeSessionRequired: "先にタスクを送信してください。親セッションの実行中に子 Agent を作成できます。",
