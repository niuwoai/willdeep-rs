...
const zhCN = {
  ...
  runtimeActivity: "Runtime 活动", tools: "工具", running: "运行中", artifacts: "产物", agents: "Agent", agent: "Agent", needsAttention: "需要处理", waitingApproval: "等待审批", waitingAnswer: "等待回答", blocked: "已阻塞", turn: "轮次", unknownValue: "—", tokenUnit: "Token", secondsUnit: "秒", worktree: "工作树",
  allowOnce: "允许一次", deny: "拒绝", alwaysAllow: "始终允许", submitAnswer: "提交", otherAnswer: "其他回答", instruct: "补充指令", retry: "重试", agentPrompt: "输入要补充给 Agent 的指令", runtimeActionFailed: "Runtime 操作失败",
...
const en: Messages = {
  ...
  runtimeActivity: "Runtime activity", tools: "Tools", running: "Running", artifacts: "Artifacts", agents: "Agents", agent: "Agent", needsAttention: "Needs attention", waitingApproval: "Waiting for approval", waitingAnswer: "Waiting for answer", blocked: "Blocked", turn: "Turn", unknownValue: "—", tokenUnit: "tokens", secondsUnit: "s", worktree: "worktree",
  allowOnce: "Allow once", deny: "Deny", alwaysAllow: "Always allow", submitAnswer: "Submit", otherAnswer: "Other answer", instruct: "Instruct", retry: "Retry", agentPrompt: "Enter an instruction for the Agent", runtimeActionFailed: "Runtime action failed",
...
const ja: Messages = {
  ...
  runtimeActivity: "Runtime アクティビティ", tools: "ツール", running: "実行中", artifacts: "成果物", agents: "Agent", agent: "Agent", needsAttention: "要対応", waitingApproval: "承認待ち", waitingAnswer: "回答待ち", blocked: "ブロック中", turn: "ターン", unknownValue: "—", tokenUnit: "トークン", secondsUnit: "秒", worktree: "Worktree",
  allowOnce: "一度許可", deny: "拒否", alwaysAllow: "常に許可", submitAnswer: "送信", otherAnswer: "その他の回答", instruct: "指示を追加", retry: "再試行", agentPrompt: "Agent への追加指示を入力", runtimeActionFailed: "Runtime 操作に失敗しました",
