...
const zhCN = {
  ...
  newReadOnlyAgent: "新建只读子 Agent", agentProfile: "Agent 类型", agentProfileScout: "侦查", agentProfileReader: "阅读", agentProfileDeep: "深度调研", agentTask: "Agent 任务", agentTaskPlaceholder: "描述独立调查任务", spawnAgent: "创建", activeSessionRequired: "请先发送一个任务；父会话运行期间可创建子 Agent。",
  details: "详情", agentDetails: "Agent 详情", taskDetails: "任务详情", closeDetails: "关闭详情", interrupted: "已中断", duration: "耗时", exitCode: "退出码", failureDomain: "失败类别", failureProvider: "Provider", failurePolicy: "权限策略", failureTool: "工具", failureHarness: "Harness", failureInternal: "内部", noStructuredActivity: "暂无结构化活动", structuredToolLog: "工具时间线", diffArtifacts: "Diff 产物", changedItems: "项变更", currentTool: "当前工具", structuredLogPrivacy: "仅显示脱敏后的结构化状态，不包含 Prompt、工具参数、输出或内部错误。",
...
const en: Messages = {
  ...
  newReadOnlyAgent: "New read-only child Agent", agentProfile: "Agent profile", agentProfileScout: "Scout", agentProfileReader: "Reader", agentProfileDeep: "Deep research", agentTask: "Agent task", agentTaskPlaceholder: "Describe an independent investigation", spawnAgent: "Create", activeSessionRequired: "Send a task first; child Agents can be created while the parent session is active.",
  details: "Details", agentDetails: "Agent details", taskDetails: "Task details", closeDetails: "Close details", interrupted: "Interrupted", duration: "Duration", exitCode: "Exit code", failureDomain: "Failure domain", failureProvider: "Provider", failurePolicy: "Policy", failureTool: "Tool", failureHarness: "Harness", failureInternal: "Internal", noStructuredActivity: "No structured activity yet", structuredToolLog: "Tool timeline", diffArtifacts: "Diff artifacts", changedItems: "changes", currentTool: "Current tool", structuredLogPrivacy: "Shows redacted structured status only; prompts, tool arguments, outputs, and internal errors are not included.",
...
const ja: Messages = {
  ...
  newReadOnlyAgent: "読み取り専用子 Agent を作成", agentProfile: "Agent プロファイル", agentProfileScout: "偵察", agentProfileReader: "読解", agentProfileDeep: "詳細調査", agentTask: "Agent タスク", agentTaskPlaceholder: "独立した調査タスクを入力", spawnAgent: "作成", activeSessionRequired: "先にタスクを送信してください。親セッションの実行中に子 Agent を作成できます。",
  details: "詳細", agentDetails: "Agent 詳細", taskDetails: "タスク詳細", closeDetails: "詳細を閉じる", interrupted: "中断", duration: "所要時間", exitCode: "終了コード", failureDomain: "失敗区分", failureProvider: "Provider", failurePolicy: "ポリシー", failureTool: "ツール", failureHarness: "Harness", failureInternal: "内部", noStructuredActivity: "構造化アクティビティはまだありません", structuredToolLog: "ツールタイムライン", diffArtifacts: "Diff 成果物", changedItems: "件の変更", currentTool: "現在のツール", structuredLogPrivacy: "秘匿化された構造化状態のみを表示し、Prompt、ツール引数、出力、内部エラーは含みません。",
