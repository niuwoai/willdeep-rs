...
const zhCN = {
  ...
  runtimeActivity: "Runtime 活动", tools: "工具", running: "运行中", artifacts: "产物",
...
const en: Messages = {
  ...
  runtimeActivity: "Runtime activity", tools: "Tools", running: "Running", artifacts: "Artifacts",
...
const ja: Messages = {
  ...
  runtimeActivity: "Runtime アクティビティ", tools: "ツール", running: "実行中", artifacts: "成果物",
